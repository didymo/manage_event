...
class OneTimeLoginController extends ControllerBase {
  ...
  /**
   * Functio to provide one-time login functionality.
   */
  ...
  /**
   * Function to redirect the user to the destination of one-time login.
   */
  ...
  /**
   * Function to validate the user and redirect the one-time login destination.
   */
